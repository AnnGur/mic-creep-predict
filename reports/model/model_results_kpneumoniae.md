...
**Generated**: 2026-06-24 17:50
---
## Evaluation Metrics
| Model | RMSE (all) | MAE (all) | R2 (all) | RMSE (R subset) | MAE (R subset) | N resistant |
|---|---|---|---|---|---|---|
| Linear Regression (interpretable) | 1.8363 | 1.0743 | 0.7494 | 3.8393 | 2.9217 | 4,305 |
| RF baseline | 1.5578 | 0.8582 | 0.8197 | 2.8685 | 2.1804 | 4,305 |
| XGBoost tuned | 1.7580 | 1.0629 | 0.7703 | 1.9596 | 1.1273 | 4,305 |
